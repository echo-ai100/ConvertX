...
import { buildReferralLink } from "../helpers/referral";
import { userService } from "./user";
import { t as translate, detectLocale } from "../locales";

export const referral = new Elysia().use(userService).get(
  "/referral",
  async ({ user, redirect, headers, cookie: { locale } }) => {
    ...
    const referralLink = buildReferralLink(headers, WEBROOT, referralCode);
              ...
              <div class="mb-6 p-4 bg-neutral-800 rounded-sm">
                ...
                <div class="flex gap-2">
                  ...
                  <button
                    type="button"
                    class="btn-secondary"
                    onclick={`navigator.clipboard.writeText(${JSON.stringify(referralLink)})`}
                  >
